...
_Generated: 2026-09-04T11:31:33.151Z_
...
Workspace `mcp.json` _(folder: akharin-projeh-site)_

- **c:\Users\mohammad\Desktop\akharin-projeh-site\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\mohammad\.claude.json** — _File exists — no servers defined_
